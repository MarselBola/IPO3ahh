...
public class ManaAvaiable extends Fragment implements View.OnClickListener{
    View root;
    ...
    public View onCreate(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.mana_avaiable,container, false);
        int resID, id;
    ...
    public void onClick(View v){
        ...
        if(v.getId() == R.id.bTotal){
            Fragment manatotal = new ManaAvaiable();
